...
import { VocabWrittenPractice } from "@/components/student/VocabWrittenPractice";

type Word = { id: string; ukrainian: string; answers: string[] };
type Bank = { id: string; name: string; words: Word[] };

export default function VocabWrittenPracticePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-2 py-6 md:max-w-3xl lg:max-w-4xl">
      ...
      {bank.words.length === 0 ? (
        ...
        <VocabWrittenPractice words={bank.words} />
      )}
    </div>
  );
}
